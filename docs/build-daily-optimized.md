...
| 字段                    | 值规则                                     | 示例                    | 来源                            |
| ----------------------- | ------------------------------------------ | ----------------------- | ------------------------------- |
| `name`                  | `{剧名}-小红-{抖音号}`                     | `暗香-小红-萍通剧坊`    | 飞书表格剧名 + 当前批次抖音号   |
